 ...
 let original' = 
 (M.add_item_to_cart {I.item_id = "cherry"; I.item_quantity = 4} (M.add_item_to_cart {I.item_id = "orange"; I.item_quantity = 2}
 (M.add_item_to_cart {I.item_id = "orange"; I.item_quantity = 1} (M.add_item_to_cart {I.item_id = "apple"; I.item_quantity = 2} original)))) in 
 let original'' = 
 (M.add_item_to_cart {I.item_id = "lemon"; I.item_quantity = 2} 
