...
let _ =
  ...
  let q1 =  original |> H.remove (Int64.of_int 1) |> H.remove (Int64.of_int 2) |> H.remove (Int64.of_int 3) in 
  let q2 = original |> H.remove (Int64.of_int 1) |> H.add (Int64.of_int 4) in 
